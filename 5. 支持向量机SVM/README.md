...
![线性可分](E:\Typora图片\SVM_3_linearly-separable.jpg)
...
* 现在转化到对偶问题的求解
  ...
  * 参考:  如果公式推导还是不懂，也可以参考《统计学习方法》李航-P103<学习的对偶算法>
    ![计算拉格朗日函数的对偶函数](E:\Typora图片\SVM_5_Lagrangemultiplier.png)
...
![image-20200701095026364](E:\Typora图片\image-20200701095026364.png)
...
![image-20200701101406980](E:\Typora图片\image-20200701101406980.png)
...
![image-20200701102906477](E:\Typora图片\image-20200701102906477.png)
...
![image-20200701103141555](E:\Typora图片\image-20200701103141555.png)
...
![image-20200701103641519](E:\Typora图片\image-20200701103641519.png)
...
其中距离，说白了就是点到直线的距离；只要定义带正负号的距离，是 {苹果+1} 面为正 {香蕉-1} 面为负的距离，互相乘上各自的 label ![k_8](E:\Typora图片\k_8.png "k_8") ，就和谐统一民主富强了。

![k_9](E:\Typora图片\k_9.png "k_9")
...
![k_11](E:\Typora图片\k_11.png "k_11")

稍微借用刚刚数学表达里面的内容看个有趣的东西: 

还记得我们怎么预测一个新的水果是苹果还是香蕉吗？我们代入到分界的直线里，然后通过符号来判断。

刚刚w已经被表达出来了也就是说这个直线现在变成了:  ![k_12](E:\Typora图片\k_12.png "k_12")

看似仿佛用到了所有的训练水果，但是其中 ![k_13](E:\Typora图片\k_13.png "k_13") 的水果都没有起到作用，剩下的就是小部分靠边边的 Support vectors 呀。

<b>III. dual representation</b>

![k_14](E:\Typora图片\k_14.png "k_14")

<b>如果香蕉和苹果不能用直线分割呢？</b>

![k_3](E:\Typora图片\k_3.jpg "k_3")

Kernel trick. 

其实用直线分割的时候我们已经使用了 kernel ，那就是线性 kernel , ![k_15](E:\Typora图片\k_15.png "k_15")
...
![k_4](E:\Typora图片\k_4.jpg "k_4")

![k_16](E:\Typora图片\k_16.png "k_16")

<b>如果还有梨呢？</b>

![k_5](E:\Typora图片\k_5.jpg "k_5")
